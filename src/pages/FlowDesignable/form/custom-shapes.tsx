...
import {multipleSelectShape} from "@/pages/FlowDesignable/form/custom-multiple-select";
import {autoCompleteShape} from "@/pages/FlowDesignable/form/custom-auto-complete";
import {selectShape} from "@/pages/FlowDesignable/form/custom-select";
