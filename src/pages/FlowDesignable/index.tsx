...
import {registerNode} from "@/pages/FlowDesignable/config/config-register-node";
import {CustomFlowchartFormPanel} from "@/pages/FlowDesignable/form";

import {initGraphCmds} from "@/pages/FlowDesignable/config/graph-cmd";
